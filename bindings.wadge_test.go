...
//go:linkname wasmimport_GetArguments go.wasmcloud.dev/component/gen/wasi/cli/environment.wasmimport_GetArguments
func wasmimport_GetArguments(result *go_bytecodealliance_org__cm.List[string]) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
		return __instance.Call("wasi:cli/environment@0.2.0", "get-arguments", func() unsafe.Pointer {
...
//go:linkname wasmimport_GetEnvironment go.wasmcloud.dev/component/gen/wasi/cli/environment.wasmimport_GetEnvironment
func wasmimport_GetEnvironment(result *go_bytecodealliance_org__cm.List[[2]string]) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
		return __instance.Call("wasi:cli/environment@0.2.0", "get-environment", func() unsafe.Pointer {
			ptr := unsafe.Pointer(result)
			__p.Pin(ptr)
			return ptr
		}())
...
//go:linkname wasmimport_InitialCWD go.wasmcloud.dev/component/gen/wasi/cli/environment.wasmimport_InitialCWD
func wasmimport_InitialCWD(result *go_bytecodealliance_org__cm.Option[string]) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
		return __instance.Call("wasi:cli/environment@0.2.0", "initial-cwd", func() unsafe.Pointer {
			ptr := unsafe.Pointer(result)
			__p.Pin(ptr)
			return ptr
		}())
